...
function PlayerMenu({setActiveModal}) {
  return (
    <section className='playerMenu'>
      <ul>
        <li><button className='link' onClick={() => setActiveModal("map")}><span>Mapa</span><img src={playerMenu.map} alt=''/></button></li>
        ...
        <li><button className='link' onClick={() => setActiveModal("companies")}><span>Mis Sedes</span><img src={playerMenu.corporation} alt=''/></button></li>
        <li><button className='link' onClick={() => setActiveModal("employees")}><span>Empleados</span><img src={playerMenu.employee} alt=''/></button></li>
        <li><button className='link' onClick={() => setActiveModal("maintenance")}><span>Mantenimiento</span><img src={playerMenu.maintenance} alt=''/></button></li>
        <li><button className='link' onClick={() => setActiveModal("realState")}><span>Inmobiliaria</span><img src={playerMenu.realState} alt=''/></button></li>
